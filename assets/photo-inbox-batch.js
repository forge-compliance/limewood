...
(() => {
  ...
  function install() {
    ...
    function reviewReason(row){
      ...
      if(Number.isFinite(c)&&c<0.95) reasons.push(`AI confidence is ${Math.round(c*100)}%, below the automatic filing threshold.`);
