...
const els = {
  ...
  addAsset:$('addAssetBtn'), assetBmsBtn:$('assetBmsBtn'), missingCount:$('missingCount'), criticalCount:$('criticalCount'), dashboardDocumentCount:$('dashboardDocumentCount'), qualityPercent:$('qualityPercent'), recentActivity:$('recentActivity'), globalSearch:$('globalSearch')
};
...
function showView(n){dashboardView.hidden=n!=='dashboard';registerView.hidden=n!=='register';documentView.hidden=n!=='documents';$('bmsView').hidden=n!=='bms';placeholderView.hidden=n!=='placeholder'}
