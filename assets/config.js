...
(() => {
  ...
  if(/\/electrical-distribution\.html$/i.test(location.pathname)){
    ...
    const electricalSearchUx=document.createElement('script'); electricalSearchUx.src='/assets/electrical-distribution-search-ux.js?v=20260830-1'; document.head.appendChild(electricalSearchUx);
  }
})();