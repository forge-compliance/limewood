...
$('addValve')?.addEventListener('click',()=>openValve());$('saveValve')?.addEventListener('click',saveValveRecord);$('deleteValve')?.addEventListener('click',deleteValveRecord);$('closeValveModal')?.addEventListener('click',()=>closeOpsModal('valveModal'));
