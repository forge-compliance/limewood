...
(() => {
  ...
  if(isPhotoInbox){
    ...
    const stanHeader=document.createElement('script'); stanHeader.src='/assets/photo-inbox-stan.js?v=20260915-1'; document.head.appendChild(stanHeader);
    const reviewTools=document.createElement('script'); reviewTools.src='/assets/photo-inbox-review-tools.js?v=20260915-1'; document.head.appendChild(reviewTools);
  }
