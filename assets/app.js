...
const els = {
  ...
  addAsset:$('addAssetBtn'), missingCount:$('missingCount'), criticalCount:$('criticalCount'), dashboardDocumentCount:$('dashboardDocumentCount'), qualityPercent:$('qualityPercent'), recentActivity:$('recentActivity'), globalSearch:$('globalSearch')
};
