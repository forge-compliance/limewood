(() => {
  ...
  function install(){
    ...
    if (document.getElementById('lwSiteNav') || !document.body) return;
    ...
    style.textContent=`
      ...
      #lwSiteNav{position:fixed;z-index:10000;left:0;top:0;bottom:0;width:var(--lw-site-nav-open);background:#17372c;color:#fff;box-shadow:7px 0 24px #0003;transform:translateX(calc(-1 * (var(--lw-site-nav-open) - var(--lw-site-nav-collapsed))));transition:transform .22s ease;overflow:hidden;border-radius:0!important;padding:0!important;height:100dvh!important}
      ...
      #lwSiteNavToggle{width:40px;height:40px;min-width:40px;border:0;border-radius:10px;background:#ffffff12;color:#fff;font-size:26px;display:grid;place-items:center;cursor:pointer;padding:0!important}
