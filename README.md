...
## v5.3.5
- Valve CSV importer now lists all known and database plant rooms.
- Removes Forest Cottage as the forced default.
- Remembers the last selected plant room.

## v5.3.6
- Adds **+ Add plant room** inside the valve CSV importer and valve editor.
- New rooms are saved locally immediately and synced to Supabase when available.
- New rooms appear in valve import, valve editor and register filters without another code update.
