...
if ($('waitParts')) $('waitParts').onclick=()=>updateJob(
  {status:'waiting_parts'},
  `Job placed on hold: waiting for parts`,
  'waiting_parts'
);

if ($('waitContractor')) $('waitContractor').onclick=()=>updateJob(
  {status:'waiting_contractor'},
  `Job placed on hold: waiting for contractor`,
  'waiting_contractor'
);
