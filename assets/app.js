...
async function loadOperations(){
 ...
 seedPpmFromAssets();populateOpsFilters();renderPpm();renderValves();setTimeout(openValveFromUrl,0);
}
...
$('placeholderView')?.addEventListener('click',e=>{const room=e.target.closest('[data-select-plant-room]');if(room)return showPlantRoomHub(room.dataset.selectPlantRoom);if(e.target.closest('#roomDirectoryBack,#backDashboard'))showView('dashboard');});
