...
// Creator bridge is exposed immediately so the Android Creator shell can see it
// even while the rest of the engineering app is still initialising.
window.LIMEWOOD_CREATOR = {
  openLogBuilder: (...args) => openCreatorLogBuilder(...args),
  reloadLogTemplates: (...args) => loadLogTemplates(...args),
  ready: false,
  version: '1.2.2'
};
...
window.LIMEWOOD_CREATOR.openLogBuilder = openCreatorLogBuilder;
window.LIMEWOOD_CREATOR.reloadLogTemplates = loadLogTemplates;
