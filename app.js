...
function ensureCreatorLogBuilder(){
  ...
  style.textContent=`
    ...
    @media(max-width:780px){
      ...
      .clbEditor{padding:14px;padding-bottom:calc(150px + env(safe-area-inset-bottom))}
      .clbFooter{
        position:sticky;
        ...
        box-shadow:0 -10px 24px rgba(23,61,51,.12);
      }
    ...
    @media(max-width:780px) and (orientation:landscape){
      ...
      .clbEditor{padding-bottom:calc(120px + env(safe-area-inset-bottom))}
    }
  `;
