...
function showAboutPage(){
  const card=placeholderView.querySelector('.placeholderCard');
  card.innerHTML=`<span>ABOUT</span><h2>Limewood Engineering</h2><p>Engineering Control Centre</p><div class="aboutForge"><b>Powered by Forge Compliance</b><span>Built and managed by Forge Compliance Ltd.</span><small>Version 6.0.2</small></div><button id="aboutBack">Return to dashboard</button>`;
  showView('placeholder');closeDrawer();
}
