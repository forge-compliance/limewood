...
const dashboardView=$('dashboardView'),registerView=$('registerView'),documentView=$('documentView'),complianceView=$('complianceView'),placeholderView=$('placeholderView'),registerTitle=$('registerTitle'),drawer=$('drawer'),backdrop=$('drawerBackdrop');
function closeDrawer(){drawer.classList.remove('open');backdrop.classList.remove('open');drawer.setAttribute('aria-hidden','true')}
function showView(n){dashboardView.hidden=n!=='dashboard';registerView.hidden=n!=='register';documentView.hidden=n!=='documents';complianceView.hidden=n!=='compliance';$('bmsView').hidden=n!=='bms';placeholderView.hidden=n!=='placeholder'}
