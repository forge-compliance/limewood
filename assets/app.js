...
async function confirmValveImport(){
 ...
 try{
  ...
  renderValves();setTimeout(()=>closeOpsModal('valveImportModal'),900);
...
const dashboardView=$('dashboardView'),registerView=$('registerView'),documentView=$('documentView'),complianceView=$('complianceView'),ppmView=$('ppmView'),valveView=$('valveView'),placeholderView=$('placeholderView'),registerTitle=$('registerTitle'),drawer=$('drawer'),backdrop=$('drawerBackdrop');
function closeDrawer(){drawer.classList.remove('open');backdrop.classList.remove('open');drawer.setAttribute('aria-hidden','true')}
function showView(n){dashboardView.hidden=n!=='dashboard';registerView.hidden=n!=='register';documentView.hidden=n!=='documents';complianceView.hidden=n!=='compliance';ppmView.hidden=n!=='ppm';valveView.hidden=n!=='valves';$('bmsView').hidden=n!=='bms';placeholderView.hidden=n!=='placeholder'}
